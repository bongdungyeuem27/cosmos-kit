...
export declare type WalletName = 'keplr' | 'cosmostation' | 'ledger' | 'okxwallet' | 'station' | 'leap' | 'trust' | 'ctrl' | 'vectis' | 'frontier' | 'fin' | 'omni' | 'coin98' | 'shell' | 'compass' | 'tailwind' | 'owallet' | 'exodus' | 'galaxystation' | 'cdcwallet';
...
export declare const ctrl: WalletList<import("@cosmos-kit/ctrl-extension").CTRLExtensionWallet, any>;
...
export declare const owallet: WalletList<import("@cosmos-kit/owallet-extension").OwalletExtensionWallet, import("@cosmos-kit/owallet-mobile").OWalletMobileWallet>;

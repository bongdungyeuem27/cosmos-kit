...
export declare const keplr: WalletList<import("@bongdungyeuem27-kit/keplr-extension").KeplrExtensionWallet, import("@bongdungyeuem27-kit/keplr-mobile").KeplrMobileWallet>;

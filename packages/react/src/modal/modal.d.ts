...
export declare type ThemeCustomizationProps = ModalCustomizationProps &
  Pick<
    ThemeProviderProps,
    'defaultTheme' | 'overrides' | 'themeDefs' | 'customTheme'
  >;
export declare type WalletModalComponentProps = WalletModalProps &
  ThemeCustomizationProps & {
    modalViews: typeof defaultModalViews;
    modalOptions?: ModalOptions;
    includeAllWalletsOnMobile?: boolean;
  };
export declare function WalletModal({
  isOpen,
  setOpen,
  walletRepo,
  modalViews,
  ...
  modalContentStyles,
}: WalletModalComponentProps): import('react/jsx-runtime').JSX.Element;
export declare function DefaultModal({
  isOpen,
  setOpen,
  walletRepo,
}: WalletModalProps): import('react/jsx-runtime').JSX.Element;

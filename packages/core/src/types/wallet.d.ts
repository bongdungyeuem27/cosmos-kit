...
export declare type WalletMode = 'ledger' | 'extension' | 'wallet-connect' | 'social-login';
...
export interface WalletClient {
    ...
    connect?: (chainIds: string | string[], options?: any) => Promise<void>;
...
export interface ModalOptions {
    mobile?: {
        displayQRCodeEveryTime?: boolean;
    };
}

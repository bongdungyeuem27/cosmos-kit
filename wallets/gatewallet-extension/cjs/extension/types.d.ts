...
export interface Gatewallet {
    ...
    signAmino(chainId: string, signerAddress: string, signDoc: StdSignDoc, signOptions?: SignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: SignOptions): Promise<DirectSignResponse>;

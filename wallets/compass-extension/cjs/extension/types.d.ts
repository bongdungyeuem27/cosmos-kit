...
export interface Compass {
    ...
    signAmino(chainId: string, signer: string, signDoc: StdSignDoc, signOptions?: CompassSignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: CompassSignOptions): Promise<DirectSignResponse>;

...
export interface Fin {
    ...
    signAmino(chainId: string, signer: string, signDoc: StdSignDoc, signOptions?: FinSignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: FinSignOptions): Promise<DirectSignResponse>;

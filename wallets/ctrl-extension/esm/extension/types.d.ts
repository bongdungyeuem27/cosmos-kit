...
export interface CTRL {
    ...
    signAmino(chainId: string, signer: string, signDoc: StdSignDoc, signOptions?: CTRLSignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: CTRLSignOptions): Promise<DirectSignResponse>;

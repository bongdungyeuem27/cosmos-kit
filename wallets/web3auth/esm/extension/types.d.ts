...
export declare type Web3AuthWalletInfo = Wallet & {
    options: Web3AuthClientOptions;
};
export declare type Web3AuthLoginMethod = {
    provider: LOGIN_PROVIDER_TYPE;
    name: string;
    logo: string;
};
export declare type Web3AuthClientOptions = {
...
export declare type PromptSign = (signerAddress: string, data: SignData) => Promise<boolean>;
...
export declare type ToWorkerMessage = {
    type: 'init_1';
    payload: {
        publicKey: string;
    };
...
export declare type FromWorkerMessage = {
    type: 'ready_1';
    payload: {

...
export declare class KeplrClient extends WCClient {
  ...
  getOfflineSigner(
    ...
    import('@keplr-wallet/types').OfflineAminoSigner | OfflineDirectSigner
  >;
  getOfflineSignerAmino(
    chainId: string
  ): import('@keplr-wallet/types').OfflineAminoSigner;
  ...
  ): Promise<import('@keplr-wallet/types').AminoSignResponse>;
  signDirect(
    chainId: string,
    signer: string,
    signDoc: DirectSignDoc,
    signOptions?: SignOptions
  ): Promise<import('@keplr-wallet/types').DirectSignResponse>;
  signArbitrary(
    chainId: string,
    signer: string,

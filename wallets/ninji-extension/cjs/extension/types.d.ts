...
export interface Ninji {
    ...
    signAmino(chainId: string, signer: string, signDoc: StdSignDoc, signOptions?: NinjiSignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: NinjiSignOptions): Promise<DirectSignResponse>;

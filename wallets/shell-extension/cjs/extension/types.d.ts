...
export declare type ShellMode = 'core' | 'extension' | 'mobile-web' | 'walletconnect';
...
export interface Shell {
    ...
    signAmino(chainId: string, signer: string, signDoc: StdSignDoc, signOptions?: ShellSignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: ShellSignOptions): Promise<DirectSignResponse>;
    ...
    experimentalSignEIP712CosmosTx_v0(chainId: string, signer: string, eip712: {
        ...
        primaryType: string;
    }, signDoc: StdSignDoc, signOptions?: ShellSignOptions): Promise<AminoSignResponse>;
}

...
export interface Aria {
    ...
    signAmino(chainId: string, signer: string, signDoc: StdSignDoc, signOptions?: AriaSignOptions): Promise<AminoSignResponse>;
    ...
    }, signOptions?: AriaSignOptions): Promise<DirectSignResponse>;
